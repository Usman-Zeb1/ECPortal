...
namespace Pk.Com.Jazz.ECP.Migrations
{
    ...
    [Migration("20240606070231_added nullability and constructor values")]
    partial class addednullabilityandconstructorvalues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pk.Com.Jazz.ECP.Data.Employee", b =>
                {
                    ...
                    b.HasOne("Pk.Com.Jazz.ECP.Data.EC", "ExperienceCenter")
                        .WithMany("Employees")
                        .HasForeignKey("ECID");
