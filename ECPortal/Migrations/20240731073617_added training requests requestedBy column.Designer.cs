...
namespace Pk.Com.Jazz.ECP.Migrations
{
    ...
    [Migration("20240731073617_added training requests requestedBy column")]
    partial class addedtrainingrequestsrequestedBycolumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pk.Com.Jazz.ECP.Models.EmployeeTargets", b =>
                {
                    ...
                    b.Property<string>("Business_Center")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
