...
namespace Pk.Com.Jazz.ECP.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string email)
        {
            ...
            Email = email;
            DisplayConfirmAccountLink = false; // IEmailSender Implelemented :) -- true; // Once you add a real email sender, you should remove this code that lets you confirm the account
